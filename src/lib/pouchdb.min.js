                ...
                function (e, t, n) {
                    !(function (e) {
                        ...
                        return (
                            ...
                            (f.ArrayBuffer.prototype.destroy =
                                f.prototype.destroy),
                            (f.ArrayBuffer.prototype._finish =
                                f.prototype._finish),
                        ...
                        (function () {
                            ...
                            (h.prototype.get = function (e) {
                                ...
                                (h.prototype.keys = function () {
                                    return Object.keys(this._store).map((e) =>
                                        d(e)
                                    );
                                }),
                                    ...
                                    if (!(l >= f.length)) {
                                        ...
                                        !(function (n, r) {
                                            n.forEach(function (n, o) {
                                                ...
                                                (f.open_revs = a.map(function (
                                                    e
                                                ) {
                                                    return e.rev;
                                                })),
                                                    (f.open_revs =
                                                        f.open_revs.filter(q));
                                                var l = q;
                            ...
                            function ke(e, t) {
                                ...
                                var n = C({}, e);
                                return (
                                    delete n._rev_tree, we(JSON.stringify(n))
                                );
                            }
                            var je = c.v4;
                            function qe(e) {
                                        ...
                                        (this.remove = w(
                                            ...
                                            function (e, t, n, r) {
                                                ...
                                                if (
                                                    Re(o._id) &&
                                                    "function" ==
                                                        typeof this._removeLocal
                                                )
                                                    return this._removeLocal(
                                                        i,
                                                        r
                                                    );
                                                this.bulkDocs(
                            ...
                            class We extends Ve {
                                ...
                                _setup(e, t) {
                                    if (
                                        ...
                                        (this.auto_compaction =
                                            t.auto_compaction),
                                        (this.purged_infos_limit =
                                            t.purged_infos_limit || 1e3),
                                        (this.prefix = Ye.prefix),
                                        "string" != typeof e)
                                    )
                                        throw new Error(
                                            "Missing/invalid DB name"
                                        );
                                    var n = (function (e, t) {
                                        var n = e.match(/([a-z-]*):\/\/(.*)/);
                                        if (n)
                                    ...
                                    if (
                                        ...
                                        throw new Error(
                                            "Invalid View Adapter: " +
                                                t.view_adapter
                                        );
                                    (this.taskqueue = new Ge()),
                                        (this.adapter = t.adapter),
                                        Ye.adapters[t.adapter].call(
                                            this,
                                            t,
                                            (e) => {
                                                if (e)
                                                    return this.taskqueue.fail(
                                                        e
                                                    );
                                                !(function (e) {
                                                    function t(t) {
                            ...
                            !(function (e) {
                                ...
                                (Ye.prototype.activeTasks = Ye.activeTasks =
                                    new (class {
                                        ...
                                        remove(e, t) {
                                            return (
                                                delete this.tasks[e], this.tasks
                                            );
                                        }
                                        update(e, t) {
                                    ...
                                    t.attachments && t.include_docs
                                        ? (function (e, t) {
                                              var r = e._attachments[t],
                                                  i = r.digest;
                                              n
                                                  .objectStore("attach-store")
                                                  .get(i).onsuccess = function (
                                                  e
                                              ) {
                                                  (r.body =
                            ...
                            function Wt(e, t, n, r, i, s) {
                                ...
                                function x(e, t, n, r, i, o, s, a) {
                                    ...
                                    if (
                                        ...
                                        r && (c._deleted = !0),
                                        c._attachments &&
                                            Object.keys(c._attachments).length)
                                    )
                            ...
                            function Ht(e, t, n) {
                                ...
                                return (
                                    ...
                                    e.update_seq &&
                                        ...
                                        (m.openCursor(null, "prev").onsuccess =
                                            function (e) {
                                                var t = e.target.result,
                                                    n = void 0;
                                                return (
                            ...
                            function fn(e) {
                                return e._attachments &&
                                    Object.keys(e._attachments)
                                    ? Promise.all(
                                          Object.keys(e._attachments).map(
                                              function (t) {
                                ...
                                s(function () {
                                    ...
                                    (r._changes = function (e) {
                                        ...
                                        const y = function (n, r) {
                                            ...
                                            if (r && r.results) {
                                                (i = r.results.length),
                                                    (v.last_seq = r.last_seq);
                                                let t = null,
                                                    n = null;
                                                "number" == typeof r.pending &&
                                                    (t = r.pending),
                                                    ("string" !=
                                                        typeof v.last_seq &&
                                                        "number" !=
                            ...
                            async function Cn(e, t, n, r, i, o) {
                                ...
                                const c = e.info().then(async function (c) {
                                    ...
                                    const f = (
                                        await e.registerDependentDatabase(u)
                                    ).db;
                                    f.auto_compaction = !0;
                                    const l = {
                                        name: u,
                                ...
                                async function w(t, n, i) {
                                        ...
                                        );
                                    {
                                        ...
                                        if (!(n = l.views && l.views[f]))
                                            throw new _n(
                                                `ddoc ${l._id} has no view named ${f}`
                                            );
                                        r(l, f), v(i, n);
                                        const d = await Cn(
                                            t,
                            ...
                            class Jn {
                                ...
                                writeCheckpoint(e, t) {
                                    var n = this;
                                    return this.updateTarget(e, t).then(
                                        function () {
                            ...
                            var zn = {
                                undefined: function (e, t) {
                                    return 0 === ct(e.last_seq, t.last_seq)
                                        ? t.last_seq
                                        : 0;
                                },
                                1: function (e, t) {
                            ...
                            function Yn(e, t, n, r, i) {
                                ...
                                function $() {
                                    return Fn(e, t, o.diffs, r).then(function (
                                        e
                                    ) {
                                        (o.error = !e.ok),
                                            e.docs.forEach(function (e) {
                                                delete o.diffs[e._id],
                                                    i.docs_read++,
                                                    o.docs.push(e);
                                            });
                                    });
                            ...
                            class tr extends f {
                                constructor(e, t, n, r) {
                                    ...
                                    function y(e, t, n) {
                                        -1 == e.listeners(t).indexOf(n) &&
                                            e.on(t, n);
                                    }
                                    n.live &&
                                        (this.push.on(
                                            "complete",
                                            this.pull.cancel.bind(this.pull)
                                        ),
                                        this.pull.on(
                                            "complete",
                                            this.push.cancel.bind(this.push)
                                        )),
                                        this.on("newListener", function (e) {
                                            "change" === e
                                                ? (y(this.pull, "change", s),
                                                  y(this.push, "change", a))
                                                : "denied" === e
                                                ? (y(this.pull, "denied", u),
                                                  y(this.push, "denied", c))
                                                : "active" === e
                                                ? (y(this.pull, "active", h),
                                                  y(this.push, "active", d))
                                                : "paused" === e &&
                                        ...
                                        this.on("removeListener", function (e) {
                                            "change" === e
                                                ? (this.pull.removeListener(
                                                      "change",
                                                      s
                                                  ),
                                                  this.push.removeListener(
                                                      "change",
                                                      a
                                                  ))
                                                : "denied" === e
                                                            ...
                                                            (this.replicateMethods =
                                                                {
                                                                    from: function (
                                                                        ...
                                                                        return e.constructor.replicate(
                                                                            t,
                                                                            e,
                                                                            n,
                                                                            r
